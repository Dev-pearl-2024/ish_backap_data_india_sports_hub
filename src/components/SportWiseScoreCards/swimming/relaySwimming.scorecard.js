...
const RelaySwimmingResultsScreen = ({ score }) => {
  ...
  const PoolVisualization = () => {
    const topTeams = sortedRelayTeams.slice(0, 5); // Limit to 4 teams for relay
...
const styles = StyleSheet.create({
  ...
  poolContainer: {
    height: screenHeight * 0.35, // Matches the 30% height from original
    backgroundColor: '#1759B9',
    overflow: 'hidden',
    position: 'relative',
  },
  laneContainer: {
    height: '23%', // Adjusted for 4 teams
    marginBottom: '0.5%',
    position: 'absolute',
    width: '100%',
  },
  ...
  marker: {
    ...
    borderRadius: 6,
    minWidth: 100, // Minimum width to accommodate longer names
  },
  markerFlag: {
    fontSize: 18,
    marginVertical: '1%',
